...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__1141__auto__,writer__1142__auto__,opt__1143__auto__){
return cljs.core._write(writer__1142__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__559__auto__ = reagent.impl.template.named_QMARK_(x);
...
var or__559__auto__ = reagent.impl.template.hiccup_tag_QMARK_(x);
if(cljs.core.truth_(or__559__auto__)){
return or__559__auto__;
} else {
...
var G__6822 = o;
(G__6822[reagent.impl.template.cached_prop_name(k)] = reagent$impl$template$convert_prop_value(v));
...
return (function() { 
var G__6823__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__6823 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__6824__i = 0, G__6824__a = new Array(arguments.length -  0);
while (G__6824__i < G__6824__a.length) {G__6824__a[G__6824__i] = arguments[G__6824__i + 0]; ++G__6824__i;}
  args = new cljs.core.IndexedSeq(G__6824__a,0);
} 
return G__6823__delegate.call(this,args);};
G__6823.cljs$lang$maxFixedArity = 0;
G__6823.cljs$lang$applyTo = (function (arglist__6825){
var args = cljs.core.seq(arglist__6825);
return G__6823__delegate(args);
});
...
var old_6826 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_(old_6826))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_6826)].join(''):class$));
} else {
}
...
if(cljs.core.not((function (){var and__547__auto__ = (node === document.activeElement);
if(and__547__auto__){
return reagent.impl.template.has_selection_api_QMARK_((node["type"]));
} else {
...
if(cljs.core.truth_((function (){var and__547__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__6829 = jsprops;
(G__6829["defaultValue"] = value);

(G__6829["onChange"] = ((function (G__6829,v,value,on_change){
return (function (p1__6827_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__6827_SHARP_);
});})(G__6829,v,value,on_change))
);
...
var vec__6831 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6831,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6831,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6831,(2),null);
...
var temp__4427__auto__ = (function (){var G__6833 = cljs.core.meta(v);
var G__6833__$1 = (((G__6833 == null))?null:reagent.impl.template.get_key(G__6833));
return G__6833__$1;
})();
if((temp__4427__auto__ == null)){
...
var jsprops = {"argv": v};
var G__6835_6836 = v;
var G__6835_6837__$1 = (((G__6835_6836 == null))?null:reagent.impl.template.key_from_vec(G__6835_6836));
var G__6835_6838__$2 = (((G__6835_6837__$1 == null))?null:(jsprops["key"] = G__6835_6837__$1));
...
var G__6842 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__6842) : reagent.impl.template.as_element.call(null,G__6842));
} else {
var p = (function (){var temp__4427__auto__ = (function (){var G__6843 = cljs.core.meta(argv);
var G__6843__$1 = (((G__6843 == null))?null:reagent.impl.template.get_key(G__6843));
return G__6843__$1;
})();
if((temp__4427__auto__ == null)){
return jsprops;
...
var G__6844 = (((jsprops == null))?{}:jsprops);
(G__6844["key"] = key);
...
var G__6845 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__6845;
continue;
}
} else {
...
var n__1441__auto___6846 = a.length;
var i_6847 = (0);
while(true){
if((i_6847 < n__1441__auto___6846)){
(a[i_6847] = reagent.impl.template.as_element((a[i_6847])));

var G__6848 = (i_6847 + (1));
i_6847 = G__6848;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__1441__auto___6849 = a.length;
var i_6850 = (0);
while(true){
if((i_6850 < n__1441__auto___6849)){
var val_6851 = (a[i_6850]);
if((cljs.core.vector_QMARK_(val_6851)) && ((reagent.impl.template.key_from_vec(val_6851) == null))){
(o["no-key"] = true);
} else {
}

(a[i_6850] = reagent.impl.template.as_element(val_6851));

var G__6852 = (i_6850 + (1));
i_6850 = G__6852;
continue;
} else {
}
...
if(cljs.core.truth_((function (){var and__547__auto__ = cljs.core.not(reagent.impl.component._STAR_non_reactive_STAR_);
if(and__547__auto__){
return (ctx["no-key"]);
} else {
return and__547__auto__;
...
var G__6854 = (cljs.core.count(argv) - first_child);
switch (G__6854) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__6854){
