...
(defn ^:export google-maps [{handlers :handlers :as props}]
...
(def ^:export circle (make-component-fnc js/google.maps.Circle
...
(def ^:export polyline (make-component-fnc js/google.maps.Polyline
                                  [:clickable :draggable :editable :geodesic
                                   :icons :map :path :strokeColor :strokeOpacity
                                   :strokeWeight :visible :zIndex]))


(def ^:export marker (make-component-fnc js/google.maps.Marker
